...
const _inlineRuntimeConfig = {
  app: {
    baseURL: '/',
    buildId: 'b3bfb5f2-4066-4064-b1c2-62fb039c44c6',
...
const assets = {
  '/_nuxt/B6xI1NaF.js': {
    ...
    etag: '"999f5-gADJVkd9lox7gFPHl386DMzbXpw"',
    mtime: '2025-09-26T20:45:26.992Z',
    size: 629237,
    path: '../public/_nuxt/B6xI1NaF.js',
  },
  '/_nuxt/C-xm6lig.js': {
    type: 'text/javascript; charset=utf-8',
    etag: '"26d-aMtRoAfgNCnSNkWzzbX4+W0dAHU"',
    mtime: '2025-09-26T20:45:26.991Z',
    size: 621,
    path: '../public/_nuxt/C-xm6lig.js',
  },
  '/_nuxt/D1rZgGeg.js': {
    type: 'text/javascript; charset=utf-8',
    etag: '"90e-zYM+qJ531wCqpcaWDr0KuXQKvvI"',
    mtime: '2025-09-26T20:45:26.991Z',
    size: 2318,
    path: '../public/_nuxt/D1rZgGeg.js',
  },
  '/_nuxt/DwVttesH.js': {
    type: 'text/javascript; charset=utf-8',
    etag: '"642-w2rZpZBEw/4T8aNOUo9ixeUsMaQ"',
    mtime: '2025-09-26T20:45:26.991Z',
    size: 1602,
    path: '../public/_nuxt/DwVttesH.js',
  },
  '/_nuxt/WsTczmci.js': {
    type: 'text/javascript; charset=utf-8',
    etag: '"34f2-eSvDPhICtow5bwlghlIDF9dJY0g"',
    mtime: '2025-09-26T20:45:26.991Z',
    size: 13554,
    path: '../public/_nuxt/WsTczmci.js',
  },
  '/_nuxt/_z9-3EAc.js': {
    type: 'text/javascript; charset=utf-8',
    etag: '"11e-vmn3PVqe0PfmlcikVtIB8BQsAAs"',
    mtime: '2025-09-26T20:45:26.991Z',
    size: 286,
    path: '../public/_nuxt/_z9-3EAc.js',
  },
  '/_nuxt/entry.BIh3GBoq.css': {
    type: 'text/css; charset=utf-8',
    etag: '"370b2-6s978SfNw8w0dnftokZabyXq8us"',
    mtime: '2025-09-26T20:45:26.992Z',
    size: 225458,
    path: '../public/_nuxt/entry.BIh3GBoq.css',
  },
  '/_nuxt/index.C_tDZkHI.css': {
    type: 'text/css; charset=utf-8',
    etag: '"25-X2hfSAy0+Rk7pJoCr3s/Kk9t7VM"',
    mtime: '2025-09-26T20:45:26.991Z',
    size: 37,
    path: '../public/_nuxt/index.C_tDZkHI.css',
  },
  '/_nuxt/builds/latest.json': {
    type: 'application/json',
    etag: '"47-i8p3pNg3klgBvwedXbpeTPn7mnE"',
    mtime: '2025-09-26T20:45:26.987Z',
    size: 71,
    path: '../public/_nuxt/builds/latest.json',
  },
  '/_nuxt/builds/meta/b3bfb5f2-4066-4064-b1c2-62fb039c44c6.json': {
    type: 'application/json',
    etag: '"8b-nUNuekmm9MzLUpQflsSRkhAK1rQ"',
    mtime: '2025-09-26T20:45:26.982Z',
    size: 139,
    path: '../public/_nuxt/builds/meta/b3bfb5f2-4066-4064-b1c2-62fb039c44c6.json',
  },
}
...
const _vQi5RE = eventHandler((event) => {
...
const _lazy_3fL6R7 = () => import('../routes/api/bookings.post.mjs')
const _lazy_d74guR = () => import('../routes/courses-_id_.get.mjs')
const _lazy_TsTxm1 = () => import('../routes/api/courses.get.mjs')
const _lazy_g0TpA8 = () => import('../routes/api/health.get.mjs')
const _lazy_nZCKVg = () =>
...
const handlers = [
  { route: '', handler: _vQi5RE, lazy: false, middleware: true, method: undefined },
  { route: '/api/bookings', handler: _lazy_3fL6R7, lazy: true, middleware: false, method: 'post' },
  { route: '/courses-:id', handler: _lazy_d74guR, lazy: true, middleware: false, method: 'get' },
  { route: '/api/courses', handler: _lazy_TsTxm1, lazy: true, middleware: false, method: 'get' },
  { route: '/api/health', handler: _lazy_g0TpA8, lazy: true, middleware: false, method: 'get' },
  {
    route: '/__nuxt_error',
    handler: _lazy_nZCKVg,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  ...
  { route: '/**', handler: _lazy_nZCKVg, lazy: true, middleware: false, method: undefined },
]
...
export {
  $fetch as $,
  isScriptProtocol as A,
  hash$1 as B,
  nodeServer as C,
  getResponseStatusText as a,
  getResponseStatus as b,
  createError$1 as c,
  defineEventHandler as d,
  defineRenderHandler as e,
  getQuery as f,
  getRouterParam as g,
  getRouteRules as h,
  hasProtocol as i,
