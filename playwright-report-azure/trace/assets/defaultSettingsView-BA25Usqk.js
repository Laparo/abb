...
` + h[_].replace(' at new ', ' at ')
  ...
  function _a(s, i) {
    if (i) {
      if (Wt[s] && (i.children != null || i.dangerouslySetInnerHTML != null)) throw Error(n(137, s))
        ...
        for (O in f) {
          ...
          if (
            ...
            if (O === 'style')
              if (b) {
                for (_ in b)
                  !b.hasOwnProperty(_) || (T && T.hasOwnProperty(_)) || (a || (a = {}), (a[_] = ''))
              ...
              case 1:
                ...
                if (i.flags & 4 && !lt)
                  if (a === null) f.componentDidMount()
                    ...
                    var h = i.elementType === i.type ? a.memoizedProps : Jt(i.type, a.memoizedProps)
            ...
            w.jsx('div', {
              ...
              onMouseMove: (U) => {
                if (!U.buttons) E(null)
                  ...
                  r === 'vertical' ? v(j * window.devicePixelRatio) : g(j * window.devicePixelRatio)
                }
              },
            }),
        ],
...
function zm(t) {
  ...
  const l = function (M) {
    ...
    D = function (M, H, fe) {
      return M === 43 || M === 45 ? !!(_t(H) || (H === 46 && _t(fe))) : M === 46 ? !!_t(H) : !!_t(M)
    },
    z = function () {
      return D(o, c(1), c(2))
    },
...
function Ir(t, e) {
  ...
  function g(k) {
    let C = l()
    for (C !== k && c('parsing quoted string'); !r && o() !== k; ) (o() === '\\' && l(), (C += l()))
      ...
      for (const S of E.items) {
        ...
        if (C.value === 'text') {
          if (!(A instanceof t.Scalar && typeof A.value == 'string')) {
            c.push({ message: 'Text value should be a string', range: u(S.value.range || E.range) })
            continue
          }
...
class wu {
  ...
  clearHighlight() {
    ...
    for (const r of this._renderedEntries)
      ((e = r.highlightElement) == null || e.remove(), (n = r.tooltipElement) == null || n.remove())
...
const Dx = () => ({
  ...
  Yg = ['selected', 'checked', 'pressed', 'expanded', 'level', 'disabled', 'name', 'include-hidden']
Yg.sort()
function Ai(t, e, n) {
  if (!e.includes(n))
    throw new Error(
    ...
    return r < 0
      ...
      : this._cached(
          ...
          () => {
            ...
            if (c === '>') {
              const u = yl(e, o)
              return !u || !this._matchesSimple(u, l, o) ? !1 : this._matchesParents(u, n, r - 1, o)
            }
            if (c === '+') {
              const u = Su(e, o)
              return !u || !this._matchesSimple(u, l, o) ? !1 : this._matchesParents(u, n, r - 1, o)
...
class gy {
  ...
  async _checkElementIsStable(e) {
    ...
    const c = () => {
      ...
      if (r) {
        if (!(E.x === r.x && E.y === r.y && E.width === r.width && E.height === r.height)) return !1
...
class V_ {
  ...
  _onFocus(e) {
    var n, r
    e.isTrusted &&
      (this._ignoreOverlayEvent(e) || (r = (n = this._currentTool).onFocus) == null || r.call(n, e))
  }
  _onScroll(e) {
    var n, r
    e.isTrusted &&
  ...
  _onKeyUp(e) {
    var n, r
    e.isTrusted &&
      (this._ignoreOverlayEvent(e) || (r = (n = this._currentTool).onKeyUp) == null || r.call(n, e))
  }
  updateHighlight(e, n) {
    ;((this._lastHighlightedSelector = void 0),
      (this._lastHighlightedAriaTemplateJSON = 'undefined'),
  ...
  async performAction(e) {
    ...
    await ((o = (r = this._delegate).performAction) == null ? void 0 : o.call(r, e).catch(() => {}))
  }
  recordAction(e) {
    var n, r
    ;((this._lastActionAutoexpectSnapshot = this._captureAutoExpectSnapshot()),
...
function sE(t, e) {
  ...
  return {
    ...
    setAnchors: () => {
      for (const l of n) {
        const c = r.get(l)
        if (typeof c == 'object' && c.anchor && (Te(c.node) || Re(c.node))) c.node.anchor = c.anchor
        else {
...
class Lt extends Ay {
  ...
  toString(e, n, r) {
    ...
    for (const o of this.items)
      if (!je(o)) throw new Error(`Map items must all be pairs; found ${JSON.stringify(o)} instead`)
    return (
      !e.allNullValues &&
